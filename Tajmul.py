# -*- coding: utf-8 -*-
"""
Created on Wed Feb 14 15:43:54 2024
...
W, U, Vt = cv.SVDecomp(rotation_matrix)

R = np.dot(U,Vt)
#R = np.floor(R * 10**2) / 10**2

# Create diagonal matrix from singular values
S = np.zeros_like(homography_matrix)
np.fill_diagonal(S, W.flatten())
